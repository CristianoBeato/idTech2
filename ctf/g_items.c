...
gitem_armor_t jacketarmor_info	= { 25,  50, 0.30f, 0.00f, ARMOR_JACKET};
gitem_armor_t combatarmor_info	= { 50, 100, 0.60f, 0.30f, ARMOR_COMBAT};
gitem_armor_t bodyarmor_info	= {100, 200, 0.80f, 0.60f, ARMOR_BODY};

int	jacket_armor_index = 0;
int	combat_armor_index = 0;
int	body_armor_index = 0;
static int	power_screen_index = 0;
static int	power_shield_index = 0;
